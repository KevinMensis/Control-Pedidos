            ...
            if (index < tbody.rows.length) {
                ...
                qz.websocket.connect().then(function () {
                    ...
                    return qz.websocket.disconnect().then(function () {
                        imprimir2(montoInsumo, fechaInsumo, codigoInsumo, printer, index + 31, indexFin + 31);
                    });
                });
            } else {
                                        ...
                                        <div class="form-group col-md-4">                                            
                                            <div class="form-row">
                                                <div class="col-md-7">
                                                    ...
                                                    <asp:TextBox ID="TXT_FechaInsumo" runat="server" CssClass="form-control" TextMode="Date" format="dd/MM/yyyy" Enabled="false" OnTextChanged="TXT_FechaInsumo_OnChange" AutoPostBack="true"></asp:TextBox>
                                                </div>
                                                <div class="col-md-5">
