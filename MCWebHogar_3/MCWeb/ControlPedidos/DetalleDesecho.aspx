...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function abrirModalDetalleDesecho() {
            document.getElementById('BTN_ModalDetalleDesecho').click()
        }

        function cerrarModalDetalleDesecho() {
            document.getElementById('BTN_ModalDetalleDesecho').click()
        }
        ...
        function TXT_Cantidad_onChange(txtCantidad) {
            ...
            var idUnidades = 'Content_DGV_ListaProductosDesecho_DDL_Unidades_' + index
            var idDecenas = 'Content_DGV_ListaProductosDesecho_DDL_Decenas_' + index
            var idCentenas = 'Content_DGV_ListaProductosDesecho_DDL_Centenas_' + index
            ...
            if (cantidadProducto !== '') {
                ...
                if (cantidadProducto >= 0 && cantidadProducto < 1000) {
                    ...
                    guardarCantidadProductoDesecho(index, cantidadProducto);
                }
                else {
                ...
                guardarCantidadProductoDesecho(index, 0);
            }
        }

        function guardarCantidadProductoDesecho(index, cantidad) {
            var id = 'Content_DGV_ListaProductosDesecho_HDF_IDDesechoDetalle_' + index
            var HDF_IDDesechoDetalle = document.getElementById(id)
            var idDesechoDetalle = HDF_IDDesechoDetalle.value
            var usuario = document.getElementById('Content_HDF_IDUsuario').value;
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "DetalleDesecho.aspx/guardarProductoDesecho",
                data: JSON.stringify({
                    "idDesechoDetalle": idDesechoDetalle,
        ...
        function cargarProductosAgregar() {
            ...
            var idDesecho = document.getElementById('Content_HDF_IDDesecho').value;
                ...
                productosAgregar.forEach(function (valor, clave) {
                    promises.push(
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "DetalleDesecho.aspx/BTN_Agregar_Click",
                            data: JSON.stringify({
                                "idDesecho": idDesecho,
        ...
        function imprimir(montoDesecho, fechaDesecho, codigoDesecho, printer) {
            imprimir2(montoDesecho, fechaDesecho, codigoDesecho, printer, 0, 31);
        }

        function imprimir2(montoDesecho, fechaDesecho, codigoDesecho, printer, index, indexFin) {
            var listaProductos = 'Content_DGV_DetalleDesecho';
                ...
                qz.websocket.connect().then(function () {
                    ...
                    var data = [{
                        ...
                        data: '<html>' +
                                ...
                                '<body>' +
                                    '<h2><strong>' + codigoDesecho + ' - ' + 'Fecha Desecho: ' + fechaDesecho + '</strong></h2>' +
                                    '<table>' + resultHTML + '</table><br />' +
                                    '<h2><strong>Total:</strong> ' + montoDesecho + '</h2>' +
        ...
        function estilosElementosBloqueados() {
            ...
            document.getElementById('<%= TXT_MontoDesecho.ClientID %>').classList.remove('aspNetDisabled')
            document.getElementById('<%= TXT_MontoDesecho.ClientID %>').classList.add('form-control')
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="wrapper">
        ...
        <asp:HiddenField ID="HDF_IDDesecho" runat="server" Value="0" Visible="true" />
                            ...
                            <ContentTemplate>
                                <div class="card-header py-3">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label for="TXT_MontoDesecho">Monto desecho</label>
                                            <asp:TextBox class="form-control" ID="TXT_MontoDesecho" runat="server" Enabled="false"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="form-row">                                                                                
                                        <div class="col-md-6">                                       
                                            ...
                                            <asp:Button ID="BTN_AbrirModalDetalleDesecho" runat="server" UseSubmitBehavior="false" Text="Imprimir desecho" CssClass="btn btn-info" OnClick="BTN_AbrirModalDetalleDesecho_Click"></asp:Button>                                            
                                        </div>                                        
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="row">
                                                            <asp:TextBox class="form-control" TextMode="Number" MaxLength="2" min="0" max="999" style="width: 30%" runat="server" ID="TXT_Cantidad" 
                                                                onkeyup="TXT_Cantidad_onKeyUp(this,event);" onchange="TXT_Cantidad_onChange(this);" Text='<%#Eval("CantidadDesecho") %>' />                                                            
                                                        ...
                                                        <asp:HiddenField ID="HDF_IDDesechoDetalle" runat="server" Value='<%# Eval("IDDesechoDetalle") %>' />
                                                    </ItemTemplate>
    ...
    <button type="button" id="BTN_ModalDetalleDesecho" data-toggle="modal" data-target="#ModalDetalleDesecho" style="visibility: hidden;">open</button>

    <div class="modal bd-example-modal-lg" id="ModalDetalleDesecho" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="popDetalleDesecho" aria-hidden="true">
        <asp:UpdatePanel ID="UpdatePanel_ModalDetalleDesecho" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h5 class="modal-title" runat="server">Detalle Desecho</h5>
                        </div>
                        <div class="modal-body">                            
                            <div class="table-responsive" id="tableCategorias">
                                <asp:UpdatePanel ID="UpdatePanel_DetalleDesecho" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <br />
                                        <br />
                                        <asp:GridView ID="DGV_DetalleDesecho" Width="100%" runat="server" CssClass="table" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            AutoGenerateColumns="false" DataKeyNames="IDDesechoDetalle,DesechoID,ProductoID,Categoria" HeaderStyle-CssClass="table" BorderWidth="0px" HeaderStyle-BorderColor="#51cbce" GridLines="None"
                                            ...
                                            <Columns>                                         
                                                ...
                                                <asp:BoundField DataField="CantidadDesecho" HeaderText="Cantidad Desecho" ItemStyle-ForeColor="black" ItemStyle-HorizontalAlign="Center"></asp:BoundField>                                                
                        ...
                        <div class="modal-footer">                            
                            <div style="text-align: right;">
                                ...
                                <asp:Button ID="BTN_ImprimirDetallePedido" UseSubmitBehavior="false" runat="server" Text="Imprimir" CssClass="btn btn-secondary" OnClick="BTN_ImprimirDetalleDesecho_Click" />                              
                            </div>
                        </div>
                    </div>
                </div>
