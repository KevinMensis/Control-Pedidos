            ...
            if (index < tbody.rows.length) {
                ...
                qz.websocket.connect().then(function () {
                    ...
                    return qz.websocket.disconnect().then(function () {
                        imprimir2(montoEmpaque, fechaEmpaque, codigoEmpaque, printer, index + 31, indexFin + 31);
                    });
                });
            } else {
                                        ...
                                        <div class="form-group col-md-4">                                            
                                            <div class="form-row">
                                                <div class="col-md-7">
                                                    ...
                                                    <asp:TextBox ID="TXT_FechaEmpaque" runat="server" CssClass="form-control" TextMode="Date" format="dd/MM/yyyy" Enabled="false" OnTextChanged="TXT_FechaEmpaque_OnChange" AutoPostBack="true"></asp:TextBox>
                                                </div>
                                                <div class="col-md-5">
