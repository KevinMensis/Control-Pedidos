...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function abrirModalDetalleDevolucion() {
            document.getElementById('BTN_ModalDetalleDevolucion').click()
        }
        ...
        function imprimir(montoDevolucion, fechaDevolucion, codigoDevolucion, printer) {
            imprimir2(montoDevolucion, fechaDevolucion, codigoDevolucion, printer, 0, 31);
        }

        function imprimir2(montoDevolucion, fechaDevolucion, codigoDevolucion, printer, index, indexFin) {
            var listaProductos = 'Content_DGV_DetalleDevolucion';
                ...
                qz.websocket.connect().then(function () {
                    ...
                    var data = [{
                        ...
                        data: '<html>' +
                                ...
                                '<body>' +
                                    '<h2><strong>' + codigoDevolucion + ' - ' + 'Fecha devolución: ' + fechaDevolucion + '</strong></h2>' +                                    
                                    '<table>' + resultHTML + '</table><br />' +
                                    '<h2><strong>Total:</strong> ' + montoDevolucion + '</h2>' +
                    ...
                    return qz.websocket.disconnect().then(function () {
                        imprimir2(montoDevolucion, fechaDevolucion, codigoDevolucion, printer, index + 31, indexFin + 31);
                    });
                });
            } else {
                cerrarModalDetalleDevolucion();
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
                                ...
                                <div class="card-header py-3">
                                        ...
                                        <div class="form-group col-md-4">                                            
                                            <div class="form-row">
                                                <div class="col-md-7">
                                                    ...
                                                    <asp:TextBox ID="TXT_FechaDevolucion" runat="server" CssClass="form-control" TextMode="Date" format="dd/MM/yyyy" Enabled="false" OnTextChanged="TXT_FechaDevolucion_OnChange" AutoPostBack="true"></asp:TextBox>
                                                </div>
                                                <div class="col-md-5">
                                    ...
                                    <div class="form-row">                                                                                
                                        <div class="col-md-6">                                       
                                            ...
                                            <asp:Button ID="BTN_AbrirModalDetalleDevolucion" runat="server" UseSubmitBehavior="false" Text="Imprimir devolución" CssClass="btn btn-info" OnClick="BTN_AbrirModalDetalleDevolucion_Click"></asp:Button>                                            
                                        </div>                                        
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <asp:GridView ID="DGV_ListaProductosDevolucion" Width="100%" runat="server" CssClass="table" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <asp:Label ID="LBL_Cantidad" runat="server" Text="Cantidad devolución"></asp:Label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <div class="row">
    ...
    <button type="button" id="BTN_ModalDetalleDevolucion" data-toggle="modal" data-target="#ModalDetalleDevolucion" style="visibility: hidden;">open</button>

    <div class="modal bd-example-modal-lg" id="ModalDetalleDevolucion" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="popDetalleDevolucion" aria-hidden="true">
        <asp:UpdatePanel ID="UpdatePanel_ModalDetalleDevolucion" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h5 class="modal-title" runat="server">Detalle devolución</h5>
                        </div>
                        <div class="modal-body">                            
                            <div class="table-responsive" id="tableCategorias">
                                <asp:UpdatePanel ID="UpdatePanel_DetalleDevolucion" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <br />
                                        <br />
                                        <asp:GridView ID="DGV_DetalleDevolucion" Width="100%" runat="server" CssClass="table" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            AutoGenerateColumns="false" DataKeyNames="IDDevolucionDetalle,DevolucionID,ProductoID,Categoria" HeaderStyle-CssClass="table" BorderWidth="0px" HeaderStyle-BorderColor="#51cbce" GridLines="None"
                                            ...
                                            <Columns>                                         
                                                ...
                                                <asp:BoundField DataField="CantidadDevolucion" HeaderText="Cantidad devolución" ItemStyle-ForeColor="black" ItemStyle-HorizontalAlign="Center"></asp:BoundField>                                                
                        ...
                        <div class="modal-footer">                            
                            <div style="text-align: right;">
                                ...
                                <asp:Button ID="BTN_ImprimirDetallePedido" UseSubmitBehavior="false" runat="server" Text="Imprimir" CssClass="btn btn-secondary" OnClick="BTN_ImprimirDetalleDevolucion_Click" />                              
                            </div>
                        </div>
                    </div>
                </div>
